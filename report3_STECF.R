...
plot_stecf <- function(x, type, variable = NULL, cap_year, cap_month, line_count, stecf_report, return_data = FALSE) {
        ...
        dat <- dplyr::mutate(dat, type_var = replace(type_var, RANK > 9, "other"))
...
plot_stecf(frmt_effort,type = "effort", variable= "COUNTRY", "2020","November", 8, "19-11", return_data = FALSE)
